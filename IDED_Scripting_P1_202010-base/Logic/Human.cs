...
namespace IDED_Scripting_P1_202010_base.Logic
{
    public class Human : Unit
    {
        ...
        {
            if (newClass is EUnitClass.Villager)
            {
                goto fail;
            }
            else if (newClass == UnitClass)
            {
                goto fail;
            }
            else if (newClass is EUnitClass.Soldier || newClass is EUnitClass.Squire)
            {
            ...
            else if (newClass is EUnitClass.Ranger || newClass is EUnitClass.Mage)
            {
